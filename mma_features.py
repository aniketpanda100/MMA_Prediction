...
Class: CSC 580
Description: This file attempts to improve upon mma_original.py by adding
more features. Namely, the average number of significant strikes and
takedowns against/by each fighter, the fighters' wins by KO/TKO and
submission, and their ages.
'''
